...
void Shader::setIntVec(const std::string &name, std::vector<GLint> value) const {
    glUniform1iv(glGetUniformLocation(this->m_program, name.c_str()), value.size(), &value[0]);
}
